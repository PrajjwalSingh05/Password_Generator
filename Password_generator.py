...
def display_password():
  ...
  # ************************************** making labels**********************************
    ...
    Confirmbutton=Button(FirstToplevel,text="Submit",command=ShowFiles).place(x=0,y=20)
...
def ShowFiles():
    ...
    querry = cur.fetchall()
    querry_string=""
    querry_string=querry[0]
    # print(querry)
    # print("Querry type is :",type(querry))
...
count=0
text=""
Welcome_label=Label(text=Welcome_statement,font="aerial 20 bold",borderwidth=7,relief=RAISED)
